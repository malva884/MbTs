...
RUN mkdir -p storage/framework/cache/data storage/framework/cache/laravel-excel storage/framework/cache storage/framework/sessions storage/framework/views storage/logs storage/app/pdf storage/app/all storage/app/google public/file && \
