...
class SpeditoEmailMensile implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        $subject = 'Report Spedito Mensile';

        $users = Utility::users_notify(['fi_spedito_mensile']);
