...
use App\Models\LogActivitySupllier as LogActivityModel;
use Illuminate\Support\Facades\Request;

class LogActivitySupllier extends Model
{
    use HasFactory;
    ...
    public static function addToLog($subject,$fornitore,$param,$color,$style){
        switch ($style) {
            case "new":
            case "edit":
    ...
    private static function stored($subject,$fornitore,$html,$color)
    {
        $log = [];
        $log['subject'] = $subject;
        $log['html'] = $html;
