...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'sqlsrv_fornitori' => [
            'driver' => 'sqlsrv',
            'url' => env('DATABASE_URL_F'),
            'host' => env('DB_HOST_F', 'localhost'),
            'port' => env('DB_PORT_F', '1433'),
            'database' => env('DB_DATABASE_F', 'forge'),
            'username' => env('DB_USERNAME_F', 'forge'),
        ...
        'sqlsrv_root_gp' => [
            'driver' => 'sqlsrv',
            //'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_ROOT_GP', 'localhost'),
            'port' => env('DB_PORT_ROOT_GP', '1433'),
            'database' => env('DB_DATABASE_ROOT_GP', 'forge'),
            'username' => env('DB_USERNAME_ROOT_GP', 'forge'),
            'password' => env('DB_PASSWORD_ROOT_GP', ''),
            'charset' => 'utf8',
            'prefix' => '',
            'encrypt' => 'yes',
            'trust_server_certificate' => true,
        ...
        'mysql_portale' => [
            ...
            'host' => env('DB_HOST_PORTALE', 'localhost'),
            'port' => env('DB_PORT_PORTALE', '3306'),
            'database' => env('DB_DATABASE_PORTALE', 'forge'),
            'username' => env('DB_USERNAME_PORTALE', 'forge'),
