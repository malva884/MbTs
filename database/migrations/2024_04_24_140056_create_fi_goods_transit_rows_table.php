...
return new class extends Migration
{
    ...
    {
        Schema::create('fi_goods_transit_rows', function (Blueprint $table) {
            $table->uuid('id')->primary();
            $table->unsignedBigInteger('head');
            $table->foreign('head')->references('id')->on('fi_goods_transit_heads')->onDelete('cascade');
            $table->date('date_row');
    ...
    {
        Schema::dropIfExists('fi_goods_transit_rows');
    }
};
