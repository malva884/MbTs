...
return new class extends Migration
{
    ...
    {
        Schema::create('to_cable_structures', function (Blueprint $table) {
            $table->uuid('id')->primary();
            $table->uuid('cavo_id')->index();
            $table->foreign('cavo_id')->references('id')->on('to_cables')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('to_cable_structures');
    }
};
