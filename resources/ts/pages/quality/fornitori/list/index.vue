...
const exportToExcel = () => {
  const url = `/api/export/supplier/excel?ragioneSociale=${ragioneSocialeFilter.value}&codiceSap=${codiceSapFilter.value}&categoria=${categoriaFilter.value}&qualificato=${qualificatoFilter.value ? 1 : ''}`
