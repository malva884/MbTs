...
import TipoReport from '@/pages/quality/prove/cpr/list/TipoReport.vue'
...
const loadItems = async () => {
  ...
  const {data: resultData, error} = await useApi<any>(createUrl('/qt/prove_cpr/list', {
    query: {
      page: page.value,
...
const headers = [
  ...
  {title: t('Label.Classificazione'), key: 'class'},
...
const deleteItemConfirm = async () => {
  ...
  //const retuenData = await $api(`/qt/prove_cpr/delete/${deletedItem.value.id}`, {
 //  method: 'delete',
  //})
      ...
      <VCardText class="d-flex flex-wrap py-4 gap-4">
        ...
        <div class="app-user-search-filter d-flex align-center flex-wrap gap-4">
          ...
          <VBtn
            ...
            color="success"
            :to="{ name: 'quality-prove-cpr-add-add' }"
          >
