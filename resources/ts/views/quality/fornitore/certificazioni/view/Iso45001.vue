          ...
          <VRow no-gutters>
            ...
            >
              <label
                class="v-label text-body-2 text-wrap text-high-emphasis"
                for="q-10"
              >{{ t('Questionario-45001.d10') }}</label>
            </VCol>
          ...
          <VRow no-gutters>
            ...
            >
              <label
                class="v-label text-body-2 text-wrap text-high-emphasis"
                for="q-11"
              >{{ t('Questionario-45001.d11') }}</label>
            </VCol>
          ...
          <VRow no-gutters>
            ...
            >
              <label
                class="v-label text-body-2 text-wrap text-high-emphasis"
                for="q-12"
              >{{ t('Questionario-45001.d12') }}</label>
            </VCol>
          ...
          <VRow no-gutters>
            ...
            >
              <label
                class="v-label text-body-2 text-wrap text-high-emphasis"
                for="q-13"
              >{{ t('Questionario-45001.d13') }}</label>
            </VCol>
