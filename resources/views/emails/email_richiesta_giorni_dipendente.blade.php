...
<head>
    ...
    <title>Copia di (1) Richiesta</title><!--[if (mso 16)]>
    <style type="text/css">
        a {
    ...
    <style type="text/css">
        ...
        @media only screen and (max-width: 600px) {
            ...
            *[class="gmail-fix"] {
            ...
            .es-text-5042 .es-text-mobile-size-28, .es-text-5042 .es-text-mobile-size-28 * {
                font-size: 28px !important;
                line-height: 150% !important
            }

            .es-text-7365 .es-text-mobile-size-20, .es-text-7365 .es-text-mobile-size-20 * {
                font-size: 20px !important;
                line-height: 150% !important
            }

            .es-text-1296 .es-text-mobile-size-20, .es-text-1296 .es-text-mobile-size-20 * {
                font-size: 20px !important;
                line-height: 150% !important
            }

            .es-text-9666 .es-text-mobile-size-20, .es-text-9666 .es-text-mobile-size-20 * {
                font-size: 20px !important;
                line-height: 150% !important
            }
        }
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <td align="center"
                                                                ...
                                                                <img src="https://www.metallurgicabresciana.it/assets/img/logo18.png"
                                                                     alt="" width="300" title=""
                    ...
                    <tr>
                        <td align="center" style="padding:0;Margin:0">
                            <table bgcolor="#ffffff" align="center" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                           ...
                                                           style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                        <tr>
                                                            <td align="center" class="es-m-p0r es-m-p0l es-text-5042"
                                                                style="Margin:0;padding-top:15px;padding-right:40px;padding-bottom:15px;padding-left:40px">
                                                                <h1 class="es-m-txt-c es-text-mobile-size-28"
                                                                    style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:28px;font-style:normal;font-weight:bold;line-height:36.4px !important;color:#6aa84f">
                                                                    Richiesta {{ $info['tipologia'] }}</h1></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="center"
                                                                style="padding:0;Margin:0;padding-top:10px"><h3
                                                                        style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:bold;line-height:24px;color:#333333;text-align:center">
                                                                    <em>Ciao,&nbsp;</em></h3>
                                                                <h3 style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:bold;line-height:24px;color:#333333;text-align:center">
                                                                    <em>di seguito le informazioni della richiesta:</em>
                                                                </h3>
                                                                <h2 style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:26px;font-style:normal;font-weight:bold;line-height:31.2px;color:#333333"></h2>
                                ...
                                <tr>
                                    <td align="left"
                                        style="Margin:0;padding-bottom:10px;padding-right:20px;padding-left:20px;padding-top:5px">
                                        <!--[if mso]>
                                        <table style="width:560px" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="width:270px" valign="top"><![endif]-->
                                        <table align="left" cellpadding="0" cellspacing="0" class="es-left" role="none"
                                               style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:left">
                                            <tr>
                                                <td align="left" class="es-m-p20b"
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                           ...
                                                           style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                        <tr>
                                                            <td align="center" class="es-text-1296"
                                                                style="padding:0;Margin:0"><h5
                                                                        style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:normal;line-height:24px !important;color:#333333">
                                                                    <span class="es-text-mobile-size-20"
                                                                          style="color:#0b5394;font-size:20px">{{ $info['dipendente'] }}</span>
                                                                </h5></td>{{ $info['dipendente'] }}
                                                        </tr>
                                                    </table>
                                                </td>
                                        ...
                                        <!--[if mso]></td>
                                        <td style="width:136px" valign="top"><![endif]-->
                                        <table cellpadding="0" cellspacing="0" align="left" class="es-left" role="none"
                                               style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:left">
                                            <tr>
                                                <td align="left" class="es-m-p20b"
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                           ...
                                                           style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                        <tr>
                                                            <td align="center" style="padding:0;Margin:0"><h5
                                                                        style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:normal;line-height:24px !important;color:#333333">
                                                                    <span style="color:#0b5394">{{ $info['matricola'] }}</span>
                                                                </h5></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                        ...
                                        <td style="width:134px" valign="top"><![endif]-->
                                            ...
                                            <tr>
                                                <td align="left" style="padding:0;Margin:0;width:134px">
                                                    <table cellspacing="0" width="100%" role="presentation"
                                                        ...
                                                        <tr>
                                                            <td align="center" style="padding:0;Margin:0"><h5
                                                                        style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:normal;line-height:24px !important;color:#0b5394">{{ $info['tipologia'] }}</h5>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                ...
                                <tr>
                                    <td align="left"
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <td align="center" style="padding:0;Margin:0"><h2
                                                                        style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:26px;font-style:normal;font-weight:bold;line-height:26px !important;color:#333333">
                                                                    <strong>Approvatori</strong></h2></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                <td class="es-hidden" style="padding:0;Margin:0;width:20px"></td>
                                            ...
                                            <tr>
                                                <td align="left" class="es-m-p20b"
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                           ...
                                                           style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                        <tr>
                                                            <td align="center" style="padding:0;Margin:0"><h6
                                                                        style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:16px;font-style:normal;font-weight:normal;line-height:19.2px;color:#333333"></h6>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                        ...
                                        <!--[if mso]></td>
                                        <td style="width:20px"></td>
                                        <td style="width:210px" valign="top"><![endif]-->
                                        <table cellspacing="0" align="right" cellpadding="0" class="es-right"
                                               role="none"
                                               style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:right">
                                            <tr>
                                                <td align="left" style="padding:0;Margin:0;width:210px">
                                                    <table cellspacing="0" width="100%" role="presentation"
                                                           cellpadding="0"
                                                           style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                        <tr>
                                                            <td align="right" style="padding:0;Margin:0"><h2
                                                                        style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:26px;font-style:normal;font-weight:bold;line-height:26px !important;color:#333333">
                                                                    <strong>Giorni Richiesti</strong></h2></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                ...
                                <tr>
                                    <td align="left"
                                            ...
                                            <tr>
                                                <td align="left" class="es-m-p20b"
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                           ...
                                                           style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                        <tr>
                                                            <td align="center" class="es-text-9666"
                                                                style="padding:0;Margin:0">
                                                                @foreach($approvatori as $approvatore)
                                                                    <h4 style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:24px;font-style:normal;font-weight:normal;line-height:28.8px;color:#333333">
                                                                        <span class="es-text-mobile-size-20"
                                                                              style="color:#0b5394;font-size:20px">{{ $approvatore }}</span>
                                                                    </h4>
                                                            @endforeach
                                                        </tr>
                                                    </table>
                                        ...
                                        <!--[if mso]></td>
                                        <td style="width:150px" valign="top"><![endif]-->
                                        <table cellpadding="0" cellspacing="0" align="left" class="es-left" role="none"
                                               style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:left">
                                            <tr>
                                                <td align="left" class="es-m-p20b"
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <td align="left" style="padding:0;Margin:0"><h3
                                                                        style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:bold;line-height:24px;color:#f1c232;text-align:center">
                                                                    Approvato</h3></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                        ...
                                                        @foreach($giorni as $giorno)
                                                            <tr>
                                                                <td align="center" bgcolor="#efefef"
                                                                    class="es-text-7365" style="padding:0;Margin:0">

                                                                    <h4 class="es-text-mobile-size-20"
                                                                        style="Margin:0;font-family:tahoma, verdana, segoe, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:normal;line-height:24px;color:#6aa84f">
                                                                        <strong>{{ $giorno->data }}</strong></h4>
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                    </table>
                                                                ...
                                                                <table cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center" valign="top"
                                                                            ...
                                                                            <a target="_blank"
                                                                               href="https://www.youtube.com/channel/UCxzTbbWHs-K_8QadA3j0itQ/feed"
                                                                               style="mso-line-height-rule:exactly;text-decoration:underline;color:#333333;font-size:12px"><img
                                                                                        title="Youtube"
                                                                                        src="https://ffaapci.stripocdn.email/content/assets/img/social-icons/logo-black/youtube-logo-black.png"
                                                                        ...
                                                                        <td align="center" valign="top"
                                                                            style="padding:0;Margin:0"><a
                                                                                    target="_blank"
                                                                                    href="https://www.linkedin.com/company/metallurgica-bresciana-spa/mycompany/"
                                                                                    style="mso-line-height-rule:exactly;text-decoration:underline;color:#333333;font-size:12px"><img
                                                                                        title="LinkedIn"
                                                                                        src="https://ffaapci.stripocdn.email/content/assets/img/social-icons/logo-black/linkedin-logo-black.png"
                                                        ...
                                                        <tr>
                                                            <td align="center"
                                                                style="padding:0;Margin:0;padding-bottom:35px"><p
                                                                    ...
                                                                    © Metallurgica Bresciana S.p.A., Inc. All Rights
                                                                    Reserved.</p>
                                                                <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:18px;letter-spacing:0;color:#333333;font-size:12px">
                                                                    Viale G. Marconi, 31 25020 Dello - Brescia</p></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                                        ...
                                                        <tr>
                                                            <td align="center" class="es-infoblock"
                                                                style="padding:0;Margin:0"><p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:18px;letter-spacing:0;color:#3d85c6;font-size:12px">
                                                                    Questa è un’email automatica, non è prevista la
                                                                    possibilità di rispondere.</p></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
