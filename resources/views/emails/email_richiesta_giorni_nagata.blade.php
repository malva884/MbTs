                    ...
                    <tr>
                        <td align="center" class="esd-stripe">
                            <table bgcolor="#ffffff" align="center" cellpadding="0" cellspacing="0" width="600" class="es-content-body">
                                            ...
                                            <tr>
                                                <td width="560" align="center" valign="top" class="esd-container-frame">
                                                    <table cellpadding="0" cellspacing="0" width="100%">
                                                        <tbody>
                                                        <tr>
                                                            <td align="center" esd-links-underline="none" class="esd-block-text es-p15t es-p15b es-p40r es-p40l es-m-p0r es-m-p0l es-text-5042">
                                                                <h1 class="es-m-txt-c es-text-mobile-size-28" style="font-size:28px;line-height:130% !important;color:#6aa84f">
                                                                    Notifica Richiesta Negata
                                                                </h1>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="center" class="esd-block-text es-p10t">
                                                                ...
                                                                <h3 style="text-align:center">
                                                                    <em>la richiesta non è stata approvata al il dipendente:</em>
                                                                </h3>
                                                                <h2>
                                                                </h2>
                                                                <ol>
                                ...
                                <tr>
                                    <td align="left" class="esd-structure es-p20r es-p20l es-p5t es-p10b">
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                                        ...
                                                        <tr>
                                                            <td align="center" class="esd-block-text">
                                                                <h6>
                                                                    <span class="es-text-mobile-size-20" style="color: #0b5394; font-size: 20px">{{ $info['dipendente'] }}</span>
                                                                </h6>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                        ...
                                        <!--[if mso]></td><td width="85" valign="top"><![endif]-->
                                        <table cellpadding="0" cellspacing="0" align="left" class="es-left">
                                            <tbody>
                                            <tr>
                                                <td width="85" align="left" class="esd-container-frame es-m-p20b">
                                                    <table cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                                        <tbody>
                                                        <tr>
                                                            <td align="center" class="esd-block-text">
                                                                <p>
                                                                    <span style="color: #0b5394; line-height: 150% !important">{{ $info['matricola'] }}</span>
                                                                </p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                        ...
                                        <!--[if mso]></td><td width="20"></td><td width="135" valign="top"><![endif]-->
                                        <table cellpadding="0" cellspacing="0" align="right" class="es-right">
                                            <tbody>
                                            <tr>
                                                <td width="135" align="left" class="esd-container-frame">
                                                    <table cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                                        <tbody>
                                                        <tr>
                                                            <td align="center" class="esd-block-text">
                                    ...
                                    <tr>
                                        <td align="left" class="esd-structure es-p20r es-p20l es-p10t">
                                            ...
                                            <table cellpadding="0" cellspacing="0" align="left" class="es-left">
                                                <tbody>
                                                <tr>
                                                    <td width="174" align="left" class="esd-container-frame es-m-p20b">
                                                        <table cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                                            <tbody>
                                                            <tr>
                                                ...
                                                <tr>
                                                    <td width="173" align="left" class="esd-container-frame es-m-p20b">
                                                        <table cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                                            <tbody>
                                                            <tr>
                                                                <td align="center" bgcolor="#efefef" class="esd-block-text es-text-7365">
                                                                    <h4 class="es-text-mobile-size-20" style="color: #6aa84f; font-family: tahoma,verdana,segoe,sans-serif; font-size: 20px">
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" class="es-table-not-adapt es-social">
                                                                    ...
                                                                    <tr>
                                                                        <td align="center" valign="top" class="es-p40r">
                                                                            <a target="_blank" href="https://www.youtube.com/channel/UCxzTbbWHs-K_8QadA3j0itQ/feed">
                                                                                <img title="Youtube" src="https://ffaapci.stripocdn.email/content/assets/img/social-icons/logo-black/youtube-logo-black.png" alt="Yt" width="32">
                                                                            </a>
                                                                        </td>
                                                                        <td align="center" valign="top">
                                                                            <a target="_blank" href="https://www.linkedin.com/company/metallurgica-bresciana-spa/mycompany/">
                                                                                <img title="LinkedIn" src="https://ffaapci.stripocdn.email/content/assets/img/social-icons/logo-black/linkedin-logo-black.png" alt="In" width="32">
                                                                            </a>
                                                                        </td>
                                                                    </tr>
                                                                    </tbody>
