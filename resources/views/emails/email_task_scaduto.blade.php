...
<head>
    ...
    <style>
        ...
        .task-info{background:#f8f9fa;border-left:4px solid #dc3545;padding:12px 16px;margin:16px 0;border-radius:4px}
    ...
    <table class="wrap">
        ...
        <tr><td class="content">
                ...
                <p style="margin:0 0 16px;color:#555;font-size:13px">
                    Ciao <strong>{{ $userName }}</strong>, il task <strong>{{ $task->codice }}</strong> è scaduto in data <strong>{{ $task->data_scadenza }}</strong>.
                </p>
                ...
                <p style="margin:16px 0;color:#555;font-size:13px">
                    Ti invitiamo a verificare lo stato del task e ad aggiornarlo se necessario.
                </p>
            </td></tr>
        <tr><td class="footer">
